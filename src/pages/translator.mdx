...
**Note:** Read more [formatter](#custom-formatting), [interpolator](#custom-interpolations), and [placeholder](#custom-placeholder-for-missing-keys).
...
Method `Translator.t` as well as the translate function accept the same options as the [`Translator.get`](#translatorget) method.
