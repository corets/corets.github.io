...
**Note:** Given that schemas can be freely combined and defined at validation time, this means you can als do the same with sanitizers!
...
This method applies sanitizers returns the sanitized value:
